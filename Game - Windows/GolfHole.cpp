...
const int waterColor = 11;  //light blue
const int fairwayColor = 10;  //light green
const int treesColor = 10; //dark green
const int sandColor = 6;  //tan
const int standardColor = 7;  //white
const int grayColor = 8;  //gray
...
void GolfHole::display() const
{
    //top menu
    std::cout << "-------------------------------------------------------------------------------------------" << std::endl;
    std::cout << "| F - Flagstick | @ - Ball | ";
    changeColor(treesColor);
    std::cout << "T - Trees ";
    ...
    changeColor(standardColor);
    std::cout << "| ";
    changeColor(sandColor);
    std::cout << "S - Sand ";
    changeColor(standardColor);
    std::cout << "| * - Ball in trees or sand |" << std::endl;
    std::cout << "-------------------------------------------------------------------------------------------" << std::endl;
    std::cout << "\t\t\t\t\t " << "Hole Info" << std::endl;
    std::cout << "-------------------------------------------------------------------------------------------" << std::endl;
    changeColor(grayColor);
    std::cout << "| Hole Number: ";
    changeColor(standardColor);
    std::cout << course->getHoleNum();
    changeColor(grayColor);
    std::cout << " | Par: ";
    changeColor(standardColor);
    std::cout << par;
    changeColor(grayColor);
    std::cout << " | Shot Number: ";
    changeColor(standardColor);
    std::cout << holeScore + 1;
    changeColor(grayColor);
    std::cout << " | Hole Direction: ";
    changeColor(standardColor);
    std::cout << static_cast<char>(toupper(holeDirection));
    changeColor(grayColor);
    std::cout << " | Wind: ";
    changeColor(standardColor);
    std::cout << course->getWeather().getWindSpeed() << "mph " << static_cast<char>(toupper(course->getWeather().getWindDirection()));
    changeColor(grayColor);
    std::cout << " | To Par: ";
    changeColor(standardColor);
    std::cout << course->getRoundScore();
    changeColor(grayColor);
    std::cout << " |" << std::endl;
    changeColor(standardColor);
    std::cout << "-------------------------------------------------------------------------------------------" << std::endl;
...
bool GolfHole::intakeShortSwing(char club, int distance, std::string swingDirection) const
{
    ...
    for (;;)
    {
        ...
        changeColor(standardColor);
        std::cout << clubToString(club);
        changeColor(grayColor);
        std::cout << " | Swing Direction: ";
        changeColor(standardColor);
        std::cout << swingDirection;
        changeColor(grayColor);
        std::cout << " | Distance: ";
        changeColor(standardColor);
